...
<head>
  ...
  <!-- Font Awesome (CDN version instead of JS kit) -->
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/7.0.1/css/all.min.css" rel="stylesheet">

  <!-- PHP asset helper (keep if you’re using it) -->
  <link href="<?php echo assets('php_advance/assets/css/nucleo-svg.css'); ?>" rel="stylesheet" />
      ...
      <div class="col-12">
        <nav class="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid px-0">
            <a class="navbar-brand font-weight-bolder ms-sm-3" href="<?php echo url('/') ?>" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom">
              VTU Project
            </a>
