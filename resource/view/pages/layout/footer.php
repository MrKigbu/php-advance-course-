 <!--   Core JS Files   -->
  ...
  <script src="<?php echo assets('assets_admin/js/plugins/chartjs.min.js') ?>"></script>
  <!-- Kanban scripts -->
  <script src="<?php echo assets('assets_admin/js/plugins/dragula/dragula.min.js'); ?>"></script>
  <script src="<?php echo assets('assets_admin/js/plugins/jkanban/jkanban.js'); ?>"></script>
  <script>
